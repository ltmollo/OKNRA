        ...
        for (i = j; i < n; i++) {
            ...
            for (k = 0; k < j; ) {
                if ( k < max(j-BLKSIZE, 0) ){
                    ...
                    tmp0 = _mm_loadu_pd(A + IDX(i, k+8, n));
                    tmp1= _mm_loadu_pd(A + IDX(j, k+8, n));
                    tmp2 = _mm_loadu_pd(A + IDX(i, k+10, n));
                    tmp3 = _mm_loadu_pd(A + IDX(j, k+10, n));
                    tmp4 = _mm_loadu_pd(A + IDX(i, k+12, n));
                    tmp5= _mm_loadu_pd(A + IDX(j, k+12, n));
                    tmp6 = _mm_loadu_pd(A + IDX(i, k+14, n));
                    tmp7 = _mm_loadu_pd(A + IDX(j, k+14, n));
